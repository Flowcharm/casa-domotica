 ...
 *
 * @brief Check if the touchscreen is being touched
 *
 * @return `true` : the touchscreen is being touched
 * `false`: the touchscreen is **not** being touched
 */
bool TouchScreen::isTouching(void)
{
  TSPoint p = this->getPoint();
  return p.z > pressureThreshhold;
}